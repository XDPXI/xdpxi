    ...
    <>
      ...
      <Content>
        <Section>
          <p>
            ...
            <br />
            Download:{" "}
            <a href="http://cdn.xdpxi.net/xdpxi/license/mc/2.1.0/LICENSE">
              LICENSE
            </a>{" "}
            or{" "}
            <a href="http://cdn.xdpxi.net/xdpxi/license/mc/2.1.0/LICENSE.txt">
              LICENSE.txt
            </a>
            <br />
        ...
        <Section>
          ...
          <p>
            ...
            platforms like{" "}
            <span className="highlight-text">CurseForge, Modrinth</span> or
            similar sites that allow monetization, you must share{" "}
          ...
          <ul>
            ...
            <li>
              If asked, provide proof of revenue sharing. Failure to do so is a
              breach of this license.
            </li>
          </ul>
          <p>
            1. You must share 50% of all revenue with the Author.
            <br />
            2. You must contact the Author prior to monetization to arrange
            revenue sharing.
            <br />
            3. Upon request, you must provide verifiable records of revenue.
            <br />
            4. Failure to comply constitutes a breach of this license and may
        ...
        <Section>
          ...
          <p>
            Using small parts of the Mods’ code (like functions or build
            scripts) in other projects with different purposes is allowed. You
            may not use this permission for projects that directly compete with
            these Mods or copy their core features.
          </p>
        </Section>
      ...
      <Content>
        ...
        <Section>
          ...
          <p>
            Yes, you don’t need permission, but you must split{" "}
            <span className="highlight-text">50% of the revenue</span> with the
            original author. You may not relicense the software, and you may not
            reupload it to other sites besides{" "}
